...
//   Cambiar el URL segun la IP en donde este corriendo el servidor.
    ...
    var data_file = "http://10.0.1.87:8000/"+usuario+"/listas_activas/"
   ...
   http_request.onreadystatechange  = function(){
      ...
      items.push("<button id='borrar' class='btn btn-danger' style='margin-right: 10px; padding: 5px; padding-bottom: 0px; padding-top: 0px'> x </button>");
